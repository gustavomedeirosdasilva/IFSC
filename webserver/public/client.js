...
waterfall_canvas.style.backgroundColor = '#000050';
...
function getColorWaterfall(fft_point) {
    ...
    if (fft_point < waterfall_color_0) {
        ...
        var i = Math.trunc(waterfall_color_function(fft_point, waterfall_color_0, waterfall_color_0_0, 80, 255));
        return 'rgb(0, 0, ' + i + ')';
