...
function wfm_demodulator()
{
    ...
    csdr shift_addition_cc --fifo $client_dir/fifo_shift_addition_cc | csdr fir_decimate_cc 20 0.05 HAMMING | csdr bandpass_fir_fft_cc --fifo $client_dir/fifo_bandpass_fir_fft_cc 0.008 | csdr fmdemod_quadri_cf | csdr fractional_decimator_ff `python3 -c "print (float($sample_rate)/20/$audio_sample_rate)"` | csdr deemphasis_wfm_ff $audio_sample_rate 75e-6 | csdr convert_f_s16
}
